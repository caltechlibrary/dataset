//
// tbl.go provides some utility functions to move string one and
// two demensional slices into/out of one and two deminsional slices.
// it is used by the dsv1 module to support migrating legacy
